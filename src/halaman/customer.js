...
export const Customer = () => {
    ...
    const getUser = async () => {
        axios.get("http://localhost:5000/customer", { withCredentials: 'true' })
            .then((response) => {
    ...
    const deleteData = (id) => {
        axios.delete("http://localhost:5000/customer/" + id, { withCredentials: 'true' })
            .then(() => {
                getUser();
                handleTtp();
            }).catch((error) => {
    ...
    const updateProduct = async (id) => {
        axios.patch("http://localhost:5000/customer/" + id, {
            name: full_name,
            phone: phone,
            address: address,
            age: age,
